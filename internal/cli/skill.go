...
import (
	...
	"github.com/giovalgas/envault/internal/skill"
)
...
func skillInstall(app *App, dir string) error {
	if dir == "" {
		defaultDir, err := skill.DefaultDir()
		if err != nil {
			return err
		}
		dir = defaultDir
	...
	permissions, err := skill.PermissionsJSON()
	if err != nil {
		return err
	}
